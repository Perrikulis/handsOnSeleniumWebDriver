...
public class MyStoreTshirtsTest extends BaseTest{
    ...
    @BeforeTest(description= "T-shirt category opens" ,groups = {"WomenCategoryTest"})
    public void setUp() {
        tshirtsSteps.openMyStore();
        tshirtsSteps.openTshirtsCategory();
    }

    @Test(description= "T-shirt URL is checked" , groups = {"WomenCategoryTest"})
    ...
    @Test(description= "The banners is displayed" , groups = {"WomenCategoryTest"})
    ...
    @Test(description= "The texts of the banners are validated" , groups = {"WomenCategoryTest"})
    ...
    @Test(description= "Content of the t-shirts list is displayed" , groups = {"WomenCategoryTest"})
